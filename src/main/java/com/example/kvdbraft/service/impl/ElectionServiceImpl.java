...
public class ElectionServiceImpl implements ElectionService {
    ...
    private ExecutorService electionExecutor = Executors.newCachedThreadPool();
    @Resource
    ...
    public boolean startElection() {
        ...
        doSuccessElection();
        log.info("election final success, id = {} 成为leader, term = {}", cluster.getId(), persistenceState.getCurrentTerm());
        return true;
    }
